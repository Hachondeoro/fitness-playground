export const conversion = {
  ...
  "Chicken breast": {
    foodCalories: 110,
    measureGrams: 200,
    measure: "Chicken breast fillets",
    roundFactor: 2,
  }, // XXXX average weight of a chicken fillet breast
  Steak: {
    foodCalories: 235,
    measureGrams: 250,
    measure: "small Steak scotch fillet",
    roundFactor: 1,
  }, // 260 grams of steak ~ 1 6$ scotch fillet
  Potatoes: {
    foodCalories: 85,
    measureGrams: 110,
    measure: "small Potatoes",
    roundFactor: 2,
  }, // potato average
  "Sweet potatoes": {
    foodCalories: 85,
    measureGrams: 110,
    measure: "small Sweet Potatoes",
    roundFactor: 2,
  }, // potato average
  Coffee: {
    foodCalories: 25,
  ...
  Veggies: {
    foodCalories: 20,
    measureGrams: 200,
    measure: "handful of Veggies",
    roundFactor: 1,
  }, //
  Cheese: {
    foodCalories: 360,
    measureGrams: 10,
    measure: "small slice of Cheese",
    roundFactor: 1,
  }, //
};
