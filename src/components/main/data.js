...
export const conversion = {
  muesli: { number: 140, measure: "cups of Muesli" }, // 80 grams muesli ~ 0.57 cups ~ 1/2 of a medium sized cup
  "peanut butter": { number: 13, measure: "spoons of Peanut Butter" }, // 40 grams pb ~ 3 spoons (1 regular spoon is 13 grams)
  honey: { number: 10, measure: "spoons of Honey" }, // 40 grams of honey ~ 4 spoons  (1 regular spoon is 10 grams)
  greek_yogurt: { number: 250, measure: "cups of Greek Yogurt" }, // 260 grams greek yogurt ~ 1 whole medium cup
  ...
  "chicken breast": { number: 200, measure: "Chicken breast fillets" }, // XXXX average weight of a chicken fillet breast
  steak: { number: 250, measure: "small Steak scotch fillet" }, // 260 grams of steak ~ 1 6$ scotch fillet
...
export const Data = {
  ...
  gain: {
    ...
    exercise_tooltip: "We add 600 cals to each training <br/> day to lean bulk",
    exercise: [
      {
        title: "Breakfast",
        meals: [
